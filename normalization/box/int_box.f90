...
!Compute the normalization in a seperate code using the uniform box
!    Modified:
!21 August 2020
!    Author:
!Shane Flynn
...
double precision::E0,V,time1,time2,dummy,moment,mv_cutoff
