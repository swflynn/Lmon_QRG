...
!introduce a cutoff parameter to vary the number of quadrture points used
!==============================================================================!
...
allocate(Smat(NG,NG),Hmat(NG,NG),z(GH_default),w(GH_default),r(d2,NG),rr(d2))
allocate(l(d2),r_ij(d2),z1(GH_replace),w1(GH_replace))
!==============================================================================!
do i=1,Natoms
...
!==============================================================================!
call cgqf(GH_default,6,0d0,0d0,0d0,1d0,z,w)                                   !GHQ
w=w/sqrt(pi)
call cgqf(GH_replace,6,0d0,0d0,0d0,1d0,z1,w1)                                   !GHQ
w1=w1/sqrt(pi)
!==============================================================================!
do i=1,NG
  do j=i,NG
...
!==============================================================================!
      do ll=1,GH_replace**d2
        ...
        V_ij=V_ij+E
        do k=1,d2
          l(k)=mod(l(k),float(GH_replace))+1
          if(l(k).ne.1) exit
        enddo
      enddo
    else
      do ll=1,GH_default**d2
        do k=1,d2
          rr(k)=z(l(k))
        enddo
        rr=r_ij+rr/sqrt(alpha(i)+alpha(j))
...
write(99,*) 'GH Order Default==>', GH_default
write(99,*) 'GH Order Replacement==>', GH_replace
write(99,*) 'Smat Cutoff Value ==> ', cutoff
write(99,*) 'E0==>', E0
