...
!==============================================================================!
subroutine toy_3d_forces(d,x,forces)
!==============================================================================!
...
double precision,parameter::c8=2.
double precision,parameter::c9=3.
forces(1)=-(4*c1*x(1)**3 + 2*c2*x(1) + c7*x(2) + c9*x(3))
forces(2)=-(4*c3*x(2)**3 + 2*c4*x(2) + c7*x(1) + c8*x(3))
forces(3)=-(4*c5*x(3)**3 + 2*c6*x(3) + c8*x(2) + c9*x(1))
end subroutine toy_3d_forces
!==============================================================================!
