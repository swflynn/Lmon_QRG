...
!==============================================================================!
!Make a d-dimensional quasi-regular grid using the morse potential
!grid point minimization is done using the simplex method
!this is not done at all need to finish
!==============================================================================!
module morse_mod
implicit none
!==============================================================================!
...
double precision::Delta_E,deltae1,mv_cutoff,time1,time2,Moment(0:9),FTOL
...
allocate(xmax(d),PP(Npar+1,Npar), Y(Npar+1),hist(hissize,6),dist0(Npoints,6))
...
do i=1,N_MC
 ...
 PP(1,:)=(/x0(1),x0(2),x0(3)/)
 PP(2,:) = PP(1,:) + (/0.05,0.0,0.0/)
 PP(3,:) = PP(1,:) + (/0.0,0.05,0.0/)
 PP(4,:) = PP(1,:) + (/0.0,0.0,0.05/)
