...
!In normal modes the potential will be centered around (0,0), code intended for
!d2=2 case for visualizing the potential
!==============================================================================!
!    Modified:
!26 June 2020
!    Author:
...
!d1                   ==>Monomer Space := 9 for water
!d2                   ==>Monomer Subspace Lmon-d2 (2 for contour plots)
